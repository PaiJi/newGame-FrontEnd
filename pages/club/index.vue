<template lang="pug">
    el-container
        ...
        el-main
                                ...
                                el-card
                                    ...
                                    .card-info
                                        ...
                                        .card-intro
                                            p {{item.intro}}
                    el-row(:gutter='20')
                        el-col(:md="6" :lg="6" v-for="item in clubData.slice(8,12)" :key="item.id")
                            nuxt-link(v-bind:to="{name:'club-id',params:{id:item.id}}")
                                el-card
                                    .img(:style="{backgroundImage: `url(`+item.img_logo+`)`}")
                                    .card-info
                                        ...
                                        .card-intro
                                            p {{item.intro}}
                    el-row(:gutter='20')
                        el-col(:md="6" :lg="6" v-for="item in clubData.slice(12,16)" :key="item.id")
                            nuxt-link(v-bind:to="{name:'club-id',params:{id:item.id}}")
                                el-card
                                    .img(:style="{backgroundImage: `url(`+item.img_logo+`)`}")
                                    .card-info
            ...
            //-             el-button(round type="primary" @click="reloadData(last)") 上一页
            //-             el-button(round type="success" @click="reloadData(next)") 下一页
</template>
